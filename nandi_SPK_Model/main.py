...
class BaseMethod():
    ...
    def data(self):
        ...
        return [{'id': smartphonepocco.id, 
        'brand': DEV_SCALE_bran[smartphonepocco.brand], 
        'ram': DEV_SCALE_ram[smartphonepocco.ram], 
        'prosesor': DEV_SCALE_prosesor[smartphonepocco.prosesor], 
        'storage': DEV_SCALE_storage[smartphonepocco.storage], 
        'baterai': DEV_SCALE_baterai[smartphonepocco.baterai], 
        'ukuran_layar': DEV_SCALE_ukuran_layar[smartphonepocco.ukuran_layar], 
        'harga': DEV_SCALE_harga[smartphonepocco.harga]} for smartphonepocco in session.scalars(query)]
